  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-card/50 backdrop-blur-sm hover:bg-accent hover:text-accent-foreground hover-lift",
        secondary:
        ...
        gradient: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:from-primary/90 hover:to-accent/90 glow-effect",
        floating: "fab text-primary-foreground hover:scale-105",
        success: "bg-success text-success-foreground hover:bg-success/90 glow-effect",
      },
      size: {
